...
write.xlsx(Year_count, "Results/Tables/Asthma_count_year.xlsx",  append = F, row.names = T, col.names = F)
write.xlsx(State_count, "Results/Tables/Asthma_count_state.xlsx",  append = F, row.names = F)
